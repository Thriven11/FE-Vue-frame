...
/**
 * Sling Model for Voice Pricing
 */
@Model(adaptables = { Resource.class }, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL,
        resourceType = "commerce/components/product")
@Exporter(name = "jackson", selector = "voice", extensions = "json")
public interface VoicePricingModel {
    ...
    public interface Subscription {
        ...
        /**
         * @return voice rental price
         */
        @Inject
        @Named("rental.voice")
        @JsonProperty(value = "rental.voice")
        String getVoiceRental();

      /**
       * @return sms rental price
       */
      @Inject
      @Named("rental.sms")
    ...
    public interface Outgoing {
        ...
        /**
         * @return landline outgoing price
         */
        @Inject
        @Named("outgoing.landline")
        @JsonProperty(value = "outgoing.landline")
        String getLandlineOutgoing();

        /**
         * @return mobile outgoing price
         */
        @Inject
        @Named("outgoing.mobile")
        @JsonProperty(value = "outgoing.mobile")
        String getMobileOutgoing();
